...
namespace TodoApp.Data.Migrations
{
    ...
    [Migration("20260822104702_AddChronicleAndAscension")]
    partial class AddChronicleAndAscension
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoApp.Models.Character", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AscendedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("Ascensions")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("TodoApp.Models.Rpg.ChronicleEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("chronicle_entries", (string)null);
                });
            ...
            modelBuilder.Entity("TodoApp.Models.Rpg.ShopReroll", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset>("RerolledAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("StaminaPaid")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "Day", "Generation")
                        .IsUnique();

                    b.ToTable("shop_rerolls", (string)null);
                });
            ...
            modelBuilder.Entity("TodoApp.Models.Rpg.ChronicleEntry", b =>
                {
                    b.HasOne("TodoApp.Models.Rpg.Encounter", null)
                        .WithMany()
